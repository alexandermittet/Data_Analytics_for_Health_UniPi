...
\paragraph{Further Data Semantics and Missingness Analysis}
...
\subsubsection{Standardisation of Missing Values and Data Types}
...
\subsubsection{Numerical Extraction and Quality Control}
...
\subsubsection{Specific Imputations (DF1)}
...
\subsubsection{Consolidated and Aggregated Features}
...
\subsubsection{Patient Profile Construction and Feature Engineering}
...
\subsubsection{Data Integration and Completeness Analysis}
...
\subsubsection{Composite Feature Engineering and Clinical Interpretation}
...
\subsubsection{Profile Selection for Downstream Tasks}
...
\paragraph{Classification Profile}
...
\subsubsection{Distributional Characteristics and Correlation of Clinical Profiles}
...
\subsubsection{Correlation Analysis Summary}

...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{plots/6.tsc_metrics_comparison.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{plots/6.tsc_confusion_matrices.jpg}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/6.tsc_feature_importances_xgb.jpg}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/6.tsc_feature_importances_svm.jpg}
